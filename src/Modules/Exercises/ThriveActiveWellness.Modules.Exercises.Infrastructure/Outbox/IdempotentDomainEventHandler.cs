...
namespace ThriveActiveWellness.Modules.Exercises.Infrastructure.Outbox;
    ...
    where TDomainEvent : IDomainEvent
{
        ...
        OutboxMessageConsumer outboxMessageConsumer)
    {
        const string sql = 
            ...
            SELECT EXISTS(
                SELECT 1
                FROM exercises.outbox_message_consumers
        ...
        OutboxMessageConsumer outboxMessageConsumer)
    {
        const string sql =
            """
            INSERT INTO exercises.outbox_message_consumers(outbox_message_id, name)
